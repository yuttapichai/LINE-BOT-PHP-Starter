...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if($text == 'อยู่ไหน' || $text == 'บ้านอยู่ไหน'){
			...
			if($text == 'เกิดวันไหน' || $text == 'วันเกิด' || $text == 'เกิดวันที่เท่าไหร่' || $text == 'เกิดวันอะไร' || $text == 'ชื่อ' || $text == 'ชื่อไร'||$text == 'บอท' || $text == 'ชื่อไรคับ' || $text == 'ชื่อไรครับ' || $text == 'ชื่อไรคะ' || $text == 'ชื่อไรหรอ' || $text == 'ชื่ออะไร'){
				$messages = [
					'type' => 'text',
			...
			if($text == 'พ่อชื่อไร' || $text == 'พ่อชื่ออะไร' || $text == 'แม่ชื่อไร' || $text == 'แม่ชื่ออะไร' || $text == 'แฟนชื่ออะไร'){
				$messages = [
					'type' => 'text',
					'text' => 'ไม่บอกกกก'
			  	];
			...
			if($text == 'เบื่อ' || $text == 'เบื่อจัง' || $text == 'เบื่อโว้ย' || $text == 'เบื่ออออ' || $text == 'เบื่อ ทำไรดี'){
				$messages = [
					'type' => 'text',
			...
			if($text == 'ทำไรได้มั่ง' || $text == 'ทำอะไรได้บ้าง' || $text == 'ทำอะไรได้มั่ง'){
				$messages = [
					'type' => 'text',
					'text' => 'ลองถามมา ตอบได้ ผมก็จะตอบ'
			  	];
			}
