...
if (!is_null($events['events'])) {
	...
	foreach ($events['events'] as $event) {
		...
		if ($event['type'] == 'message' && $event['message']['type'] == 'text') {
			...
			if($text == 'เกิดวันไหน' || $text == 'วันเกิด' || $text == 'เกิดวันอะไร' || $text == 'ชื่อ' || $text == 'ชื่อไร'||$text == 'บอท' || $text == 'ชื่อไรคับ' || $text == 'ชื่อไรครับ' || $text == 'ชื่อไรคะ' || $text == 'ชื่อไรหรอ' || $text == 'ชื่ออะไร'){
				$messages = [
					'type' => 'text',
